...
description: 当用户要批量筛选简历、对照 JD 初筛候选人、从邮箱/招聘网站/飞书/ATS/云盘/本地文件夹收集简历、生成可人工反馈的 Excel、按岗位和推荐等级整理简历，或根据 HR 反馈修正筛选口径时使用。先用自然语言明确单岗位或多岗位需求，再做隐私脱敏、3-5 份 pilot、反馈校准和全量并发处理。
---
